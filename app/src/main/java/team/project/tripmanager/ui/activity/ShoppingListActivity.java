...
public class ShoppingListActivity extends TripBaseActivity implements OnItemDeletedListener {
        ...
        environment.getAPIService().getShoppingList(tripId).enqueue(new CustomCallback<CommonResponse>() {
            ...
            public void onResponse(Call<CommonResponse> call, Response<CommonResponse> response) {
                ...
                if (response.body() != null && response.body().getShoppingList() != null) {
                    ...
                    ShopListAdapter shopListAdapter = new ShopListAdapter(shoppingList, fromExplore, ShoppingListActivity.this);
